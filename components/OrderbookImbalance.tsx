...
const OrderbookImbalance = ({ imbalance }: OrderbookImbalanceProps) => {
  ...
  return (
    <div className="bg-black shadow-lg p-6 rounded-lg flex flex-col lg:flex-row justify-center items-center space-y-6 lg:space-y-0 lg:space-x-8 text-black lg:h-[600px]">
      <div className="w-full lg:w-1/2 pr-0 lg:pr-8 mb-6 lg:mb-0 text-white">
